...
public class mxObjectCodec
{
	 ...
	 * into the given node using {@link #encodeFields(mxCodec, Object, org.w3c.dom.Node)}
	 * and {@link #encodeElements(mxCodec, Object, org.w3c.dom.Node)}.
	 * 
	 * @param enc Codec that controls the encoding process.
	 * @param obj Object to be encoded.
	 ...
	 * {@link #writeAttribute(mxCodec, Object, String, Object, org.w3c.dom.Node)}
	 ...
	 * {@link #decode(mxCodec, org.w3c.dom.Node)}. The object is created based on the
	 * template in the calling method and is never null.
	 * 
	 * This implementation returns the input node. The return value of this
	 * function is used in {@link #decode(mxCodec, org.w3c.dom.Node)} to perform the
	 ...
	 * {@link #decode(mxCodec, org.w3c.dom.Node)}.
	 * 
	 * @param dec Codec that controls the decoding process.
	 * @param node XML node to be decoded.
