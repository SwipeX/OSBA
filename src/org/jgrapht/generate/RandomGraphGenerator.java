    ...
    implements GraphGenerator<V, E, V>
{
     ...
     * int)
     *
     * @see GraphGenerator#generateGraph(Graph, VertexFactory, java.util.Map)
     */
        ...
        implements EdgeTopologyFactory<VV, EE>
    {
         ...
         * </table>
         *
         * @see org.jgrapht.generate.RandomGraphGenerator.EdgeTopologyFactory#isNumberOfEdgesValid(Graph,
         * int)
         */
        public boolean isNumberOfEdgesValid(
            Graph<VV, EE> targetGraph,
