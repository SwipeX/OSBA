    ...
    extends SimpleDirectedGraph<V, E>
{
     ...
     * @throws org.jgrapht.experimental.dag.DirectedAcyclicGraph.CycleFoundException if the edge would induce a cycle in the graph
     *
     ...
     *
     * @throws org.jgrapht.experimental.dag.DirectedAcyclicGraph.CycleFoundException if adding an edge (fromVertex, toVertex) to
     ...
     * detection
     *
     * @throws org.jgrapht.experimental.dag.DirectedAcyclicGraph.CycleFoundException if a cycle is discovered
     */
    private void dfsF(
        V vertex,
        Set<V> df,
