    ...
    implements GraphIsomorphismInspector<IsomorphismRelation>
{
     ...
     * @param graph2
     *
     * @see #AbstractExhaustiveIsomorphismInspector(org.jgrapht.Graph, org.jgrapht.Graph, org.jgrapht.experimental.equivalence.EquivalenceComparator, org.jgrapht.experimental.equivalence.EquivalenceComparator)
     */
    public AbstractExhaustiveIsomorphismInspector(
        Graph<V, E> graph1,
        Graph<V, E> graph2)
